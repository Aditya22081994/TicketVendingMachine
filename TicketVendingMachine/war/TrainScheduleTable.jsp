...
<td colspan="4" align="center"><h2>TRAIN SCHEDULE</h2></td>
 ...
 <TR>
  ...
  <TR>
     ...
     <% } %> 
<tr>
<td colspan="2">Add/Modify Train Schedule : </td>
<td align="center" colspan="2"><form action="NewTrainSchedule.jsp">

<button  class="btn btn-success"  type="submit">Edit Train Schedule</button>
</form>
</td>
</tr>
</table>
